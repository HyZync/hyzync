                            ...
                            <div className="flex flex-col gap-6 items-start shrink-0">
                                ...
                                <div className="flex items-center gap-x-8 opacity-50 grayscale hover:grayscale-0 transition-all duration-300">
                                    {['Zendesk', 'HubSpot', 'Salesforce', 'Intercom', 'Jira'].map((source) => (
                                        <span
                                            key={source}
                                            className="text-base font-bold text-white font-display uppercase tracking-tight whitespace-nowrap hover:text-[#29B5E8] hover:drop-shadow-[0_0_10px_rgba(41,181,232,0.5)] transition-all duration-300 cursor-default"
                                        >
                                            {source}
                                        </span>
                                    ))}
